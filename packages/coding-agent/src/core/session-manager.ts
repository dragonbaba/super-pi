 ...
 * Encodes cwd into a safe directory name under ~/.sp/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.sp/agent/sessions/<encoded-cwd>/).
	 */
