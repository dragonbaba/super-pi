...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self]      Update Super Pi extensions or model catalogs
...
${chalk.bold("Environment Variables:")}
  ...
  ANTHROPIC_OAUTH_TOKEN            - Retired subscription auth; configure an API key explicitly
  ...
  SP_PACKAGE_DIR                   - Override package directory (for Nix/Guix store paths)
  SP_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  SP_TELEMETRY                     - Override install telemetry when set to 1/true/yes or 0/false/no
  SP_SHARE_VIEWER_URL              - Base URL for /share command (default: https://pi.dev/session/)

${chalk.bold("Built-in Tool Names:")}
  read       - Read file contents
  bash       - Execute bash commands
  powershell - Execute PowerShell commands on Windows (enabled by default on Windows)
