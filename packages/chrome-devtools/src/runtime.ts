...
export const MANAGED_BROWSER_PROFILE_PREFIX = "sp-chrome-devtools-profile-";
...
const configuredHost = process.env.SP_CHROME_DEVTOOLS_HOST ?? DEFAULT_HOST;
const configuredPortOverride = parseConfiguredPort(process.env.SP_CHROME_DEVTOOLS_PORT);
...
export const state: ChromeDevToolsState = {
	...
	port: configuredPort,
	configuredPort,
	hostConfigured: process.env.SP_CHROME_DEVTOOLS_HOST !== undefined,
	portConfigured: configuredPortOverride !== undefined,
	autoLaunchEnabled: process.env.SP_CHROME_DEVTOOLS_AUTO_LAUNCH !== "0",
	browserExecutable: process.env.SP_CHROME_DEVTOOLS_BROWSER,
	shuttingDown: false,
	sessionGeneration: 0,
