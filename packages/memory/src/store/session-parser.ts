...
export function parseSessionFile(filePath: string): ParsedSession | null {
  ...
  // The directory is named like "--Users-chandrateja-Documents-@super-pi/memory--"
 ...
 *
 * @param sessionsDir — Path to ~/.super-pi/agent/sessions/
 ...
 * "--Users-chandrateja-Documents-@super-pi/memory--" → "@super-pi/memory"
 */
