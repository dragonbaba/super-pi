 ...
 *
 * @see https://github.com/chandra447/@super-pi/memory/issues/108
 */
...
const REPO = "https://github.com/chandra447/@super-pi/memory";

function fail(message) {
  console.error(`\n[@super-pi/memory] ${message}`);
  console.error("");
  console.error("These scripts only work from a full source checkout:");
  console.error(`  git clone ${REPO}.git`);
  console.error("  cd @super-pi/memory && npm install");
