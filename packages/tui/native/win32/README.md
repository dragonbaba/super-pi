...
For non-Windows cross-builds, or for custom Windows toolchains, set `SP_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
SP_TUI_WIN32_TOOLCHAIN=mingw \
