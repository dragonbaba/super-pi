...
| --- | --- | --- | --- |
| N1: previews and recovery | `feat/file-change-preview-recovery` / main | 实现中 | [N1](next-phase-n1-evidence.md) |
| N2: staged single-file commit | `feat/staged-file-commit-reliability` / N1 | 未开始 | Pending |
