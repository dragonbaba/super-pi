...
try {
  ...
  const streamingFiles = ['tests/alpha-stream-stress.test.ts', 'tests/alpha-stream-corpus.test.ts', 'tests/alpha-stream-endings.test.ts', 'tests/alpha-stream-markers.test.ts', 'tests/alpha-markdown-ownership.test.ts', 'tests/alpha-assistant-update.test.ts', 'tests/alpha-retained-active.test.ts', 'tests/alpha-cli.test.ts', 'tests/alpha-active-quit.test.ts', 'tests/alpha-compaction-quit.test.ts', 'tests/alpha-session-replacement.test.ts'];
